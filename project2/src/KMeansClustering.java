...
public class KMeansClustering {
    ...
    private final ArrayList<Node> centroids;  // list of centroids generated by kmeans
    ...
    public KMeansClustering(int k, ArrayList<Node> dataset) {
        ...
        }while(!shiftCentroids());// shift centroids based on cluster means
    }
    ...
    private void assignClusters() {
        ...
        for (int i = 0; i < centroids.size(); i++) {
            ...
            if (clusters.get(i).size() == 0) {
                //safePrintln("Empty cluster found. Adding nearest point");
