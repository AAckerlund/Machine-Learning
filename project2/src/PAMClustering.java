...
public class PAMClustering {
    ...
    public PAMClustering(int k, ArrayList<Node> dataset, Driver driver) throws FileNotFoundException
    {
        this.driver = driver;
    ...
    private void changeMedoids() throws FileNotFoundException
    {
        ...
        while (medoidsChanged && iterations < maxIterations) {
            ...
            driver.safePrintln("Iteration: " + iterations);
            iterations++;
            medoidsChanged = false;
            for (int i = 0; i < k; i++) {
                //safePrintln("Iteration: " + i);
